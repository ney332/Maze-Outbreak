...
## Conceito
Maze Outbreak e um jogo 3D em primeira pessoa de terror e sobrevivencia. O jogador acorda em uma sequencia de labirintos e precisa encontrar a taça da libertadores antes que zumbis patrulhando os corredores o alcancem.

## Genero
Terror, sobrevivencia, labirinto, primeira pessoa.

## Objetivo
Encontrar a taça e sobreviver ate concluir a Fase 4.
...
## Inimigos
Os zumbis patrulham pontos do labirinto, detectam o jogador por distancia, perseguem quando o jogador entra na area de deteccao e causam Game Over ao encostar no jogador.
...
## Condicao de vitoria
Encontrar a taça final da Fase 4.

## Condicao de derrota
Ser encostado por qualquer zumbi em qualquer fase.

## Assets utilizados
- Labirintos  gerados com cubos para paredes e cubos achatados para o piso.
